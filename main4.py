...
def create_data_model(time_matrix, num_vehicles, demands, vehicle_capacities, depot_index):
...
def main():
    ...
    data = create_data_model(time_matrix, num_vehicles, demands, vehicle_capacities, depot_index)
